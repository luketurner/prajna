...
This is an Expo/React Native mobile application. Prioritize mobile-first patterns, performance, and cross-platform compatibility. Note that the app is Android-only so do not include iOS-specific code.
